...
namespace TRPGGMTool.Interfaces.IServices
{
    ...
    public interface IScenarioBusinessService
    {
        ...
        TRPGGMTool.Models.ScenarioModels.Scenario CreateNewScenario(string title = "新しいシナリオ");
        ...
        Task<ValidationResult> ValidateAsync(TRPGGMTool.Models.ScenarioModels.Scenario scenario);
    }
}